...
async def run():
    ...
    if resultados:
        ...
        with open("data/tramite_expedientes.csv", "w", newline="", encoding="utf-8") as f:
        ...
        # Intervinientes
        with open("data/tramite_intervinientes.csv", "w", newline="", encoding="utf-8") as f:
            writer = csv.writer(f)
        ...
        # Resoluciones
        with open("data/tramite_resoluciones.csv", "w", newline="", encoding="utf-8") as f:
            writer = csv.writer(f)
        ...
        # Radicaciones (historial completo)
        with open("data/tramite_radicaciones.csv", "w", newline="", encoding="utf-8") as f:
            writer = csv.writer(f)
    ...
    print("data/tramite_radicaciones.csv")
